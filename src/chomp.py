    ...
    def __tokenizeLine(self, line):
        ...
        for i in range(len(self.keywords)):
            ...
            if currKeyword in noQuotedMaterial:
                ...
                self.lineTokens.append(currKeyword)
